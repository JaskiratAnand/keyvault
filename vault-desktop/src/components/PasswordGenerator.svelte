...
<div class="flex flex-col h-full justify-between text-zinc-100 overflow-hidden">
    <div class="space-y-4 overflow-y-auto pr-1 grow">
        ...
        >
            ...
            <div class="flex items-center gap-0.5 shrink-0">
                <Button
                    variant="ghost"
                    size="icon"
                    class="h-8 w-8 text-zinc-400 hover:text-white cursor-pointer"
                    onclick={generate}
                    title="Regenerate"
                >
                    <RefreshCw
        ...
        >
            <button
                class="text-xs h-7.5 rounded-md font-medium transition-all duration-200 flex items-center justify-center cursor-pointer {mode ===
                'Password'
    ...
    <div class="p-0 pt-2 shrink-0">
        <Button
            class="w-full bg-zinc-50 text-zinc-950 hover:bg-zinc-200 text-xs font-bold uppercase tracking-wider h-9 flex items-center justify-center gap-1.5 cursor-pointer"
            onclick={generate}
        >
            <RefreshCw
